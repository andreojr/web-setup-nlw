...
export function HabitDay({ defaultCompleted = 0, amount = 0, date }: HabitDayProps) {
    ...
    return (
        <Popover.Root>
            <Popover.Trigger
                className={clsx('w-10 h-10 rounded-lg transition-colors focus:outline-none focus:ring-1 focus:ring-violet-600 focus:ring-offset-2 focus:ring-offset-black', {
            ...
            <Popover.Portal>
                <Popover.Content className='min-w-[320px] p-6 rounded-2xl bg-zinc-900 flex flex-col border-2 border-zinc-800 focus:outline-none focus:ring-1 focus:ring-violet-600 focus:ring-offset-2 focus:ring-offset-black'>
